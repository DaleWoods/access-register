...
async function main() {
  ...
  // A deployed demo must not ship with a password that is written down in the
  // repository. SEED_PASSWORD is generated by the platform; the literal below
  // is only ever used on a local development machine.
  ...
  console.log(
    process.env.SEED_PASSWORD
      ? "Password for all three: the value of SEED_PASSWORD"
      : `Password for all three: ${demoPassword}`,
  );
}
